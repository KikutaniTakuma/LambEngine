...
void GameScene::Initialize() {
	...
	currentCamera_->Update(player_->GetPos());
...
void GameScene::Update() {
	...
	if (!isDebugCamera_) {
		...
		if (!isGameClear_) {
			...
			player_->Update(*currentCamera_);


			enemy_->Debug("Boss");
			enemy_->Update(*player_, *currentCamera_);
			...
			currentCamera_->rotate.y = player_->GetRotate();
...
void GameScene::Draw() {
	...
	if (!isGameClear_) {
		...
		enemy_->AfterDraw(*currentCamera_);
