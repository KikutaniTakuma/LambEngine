...
private:
	...
	struct Interval {
		std::unique_ptr<Texture2D> left;
		std::unique_ptr<Texture2D> right;
	};
public:
	Customize();
...
private:
	...
	// カスタマイズ自身が持ってる
	std::unique_ptr<Texture2D> customizeBackGroundTexture_;
	std::unique_ptr<Texture2D> customizeBaseTexture_;

	std::unique_ptr<Model> cursorSail_;
	std::unique_ptr<Model> cursorBone_;
	std::unique_ptr<Model> cursorCannon_;
	std::unique_ptr<Model> cursorLoopCannon_;

	std::unique_ptr<Texture2D> cursorNumbers_;
	std::unique_ptr<Texture2D> cursorSailTexture_;
	std::unique_ptr<Texture2D> cursorCannonTexture_;
	std::unique_ptr<Texture2D> cursorLoopCannonTexture_;
	...
	std::unique_ptr<Texture2D> cursorTexture_;
	...
	std::unique_ptr<Texture2D> explanationCursorTexture_;
	std::unique_ptr<Texture2D> explanationCannonTexture_;
	std::unique_ptr<Texture2D> explanationLoopCannonTexture_;
	std::unique_ptr<Texture2D> explanationSailTexture_;

	std::unique_ptr<Texture2D> startTexture_;
	std::unique_ptr<Texture2D> gearTexture_;
	std::unique_ptr<Texture2D> toStageSelectTexture_;

	std::unique_ptr<Texture2D> maxSailCountTexture_;
	std::unique_ptr<Texture2D> maxCannonCountTexture_;
	std::unique_ptr<Texture2D> maxLoopCannonCountTexture_;
